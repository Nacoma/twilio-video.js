...
// NOTE(mpatwardhan): if a transform function is specified, use it.
// This provides a debugging tool for developers to update sdp before applying.
if (typeof window.localSdpTransform === 'function') {
  ...
  RTCPeerConnection.prototype.setLocalDescription = function setLocalDescription(description) {
    var descriptionOrPromise = window.localSdpTransform(description);
    if (typeof descriptionOrPromise.then !== 'function') {
      return origSetLocalDescription.call(this, descriptionOrPromise);
    }
    return descriptionOrPromise.then(transformedDescription => origSetLocalDescription.call(this, transformedDescription));
  };
}
